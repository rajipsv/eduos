    ...
    <header class="landing-header">
      <div class="landing-header-inner">
        <a href="#" class="landing-logo" data-scroll="top" aria-label="Tutorsala home">
          <span class="brand-icon"><svg viewBox="0 0 100 110" width="1.4em" height="1.4em" xmlns="http://www.w3.org/2000/svg"><circle cx="40" cy="25" r="12" fill="currentColor"/><path d="M22 65 C22 40 58 40 58 65 Z" fill="currentColor"/><circle cx="65" cy="38" r="9" fill="var(--primary-bright, #52b788)" stroke="var(--primary-soft, #d8f3dc)" stroke-width="2"/><path d="M45 68 C45 52 78 52 78 68 Z" fill="var(--primary-bright, #52b788)" stroke="var(--primary-soft, #d8f3dc)" stroke-width="2"/><path d="M15 82 Q30 75 50 98 Q70 75 85 82 L85 86 Q70 80 50 104 Q30 80 15 86 Z" fill="currentColor" stroke="var(--primary-soft, #d8f3dc)" stroke-width="2.5" stroke-linejoin="round"/><path d="M12 75 Q30 65 50 90 Q70 65 88 75 L88 80 Q70 72 50 96 Q30 72 12 80 Z" fill="currentColor" stroke="var(--primary-soft, #d8f3dc)" stroke-width="2.5" stroke-linejoin="round"/><path d="M10 65 Q30 50 50 82 Q30 70 10 75 Z" fill="currentColor" stroke="var(--primary-soft, #d8f3dc)" stroke-width="2.5" stroke-linejoin="round"/><path d="M90 65 Q70 50 50 82 Q70 70 90 75 Z" fill="currentColor" stroke="var(--primary-soft, #d8f3dc)" stroke-width="2.5" stroke-linejoin="round"/><path d="M22 66 Q35 62 45 78 M78 66 Q65 62 55 78" stroke="var(--primary-soft, #d8f3dc)" stroke-width="2.5" fill="none" stroke-linecap="round"/><path d="M70 21 L73 8 M80 26 L90 19 M83 38 L94 38" stroke="var(--primary-bright, #52b788)" stroke-width="3.5" stroke-linecap="round"/></svg></span>
