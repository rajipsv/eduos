    ...
    <header class="landing-header">
      <div class="landing-header-inner">
        <a href="#" class="landing-logo" data-scroll="top" aria-label="Tutorsala home">
          <span class="brand-icon"><svg viewBox="0 0 100 80" width="1.4em" height="1.4em" xmlns="http://www.w3.org/2000/svg"><circle cx="35" cy="25" r="11" fill="currentColor"/><path d="M15 60 C15 42 55 42 55 60 Z" fill="currentColor"/><circle cx="65" cy="40" r="8.5" fill="var(--accent, #bc6c25)"/><path d="M45 60 C45 48 80 48 80 60 Z" fill="var(--accent, #bc6c25)"/><path d="M5 65 Q25 53 50 72 L50 82 Q25 63 5 75 Z" fill="currentColor"/><path d="M95 65 Q75 53 50 72 L50 82 Q75 63 95 75 Z" fill="currentColor"/><path d="M68 20 L71 12 M76 25 L85 18 M80 35 L90 32" stroke="var(--accent, #bc6c25)" stroke-width="3.5" stroke-linecap="round"/></svg></span>
